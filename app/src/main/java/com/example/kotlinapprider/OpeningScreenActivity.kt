...
class OpeningScreenActivity : AppCompatActivity() {
    ...
    private fun delayOpeningScreen() {
        Completable.timer(3, TimeUnit.SECONDS, AndroidSchedulers.mainThread())
                .subscribe({
                    // Toast.makeText(this@OpeningScreenActivity,"Opening Screen",Toast.LENGTH_SHORT).show()
        ...
        listener= FirebaseAuth.AuthStateListener  { myFirebaseAuth->
            ...
            if(user != null)
            {
                FirebaseInstanceId.getInstance()
                    .instanceId
                    .addOnFailureListener { e-> Toast.makeText(this@OpeningScreenActivity,e.message,Toast.LENGTH_LONG).show() }
                    .addOnSuccessListener{ instanceIdResult ->

                        Log.d("TOKEN",instanceIdResult.token)
                        UserUtils.updateToken(this@OpeningScreenActivity,instanceIdResult.token)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode== LOGIN_REQUEST_CODE) {
            ...
            if(resultCode == Activity.RESULT_OK)
            {
                ...
                Toast.makeText(this@OpeningScreenActivity,""+response!!.error!!.message,Toast.LENGTH_SHORT).show()
        }
    }
        ...
        riderInfoRef
                ...
                .addListenerForSingleValueEvent(object : ValueEventListener {
                    ...
                    override fun onCancelled(p0: DatabaseError) {
                        Toast.makeText(this@OpeningScreenActivity,p0.message, Toast.LENGTH_SHORT).show()
                    }
    ...
    private fun showRegisterLayout() {
        ...
        btn_continue.setOnClickListener {
            ...
            {
                Toast.makeText(this@OpeningScreenActivity,"Please enter First Name",Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
            else if(TextUtils.isDigitsOnly(edt_phone_number.text.toString()))
            {
                Toast.makeText(this@OpeningScreenActivity,"Please enter Phone Number",Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
            else
            {
                ...
                riderInfoRef.child(FirebaseAuth.getInstance().currentUser!!.uid)
                    ...
                    .addOnFailureListener{ e->
                        Toast.makeText(this@OpeningScreenActivity,"sss"+e.message,Toast.LENGTH_SHORT).show()
                        dialog.dismiss()
                        progress_bar.visibility= View.GONE

                    }
                    .addOnSuccessListener {
                        Toast.makeText(this@OpeningScreenActivity,"Succesfully Registered",Toast.LENGTH_SHORT).show()
                        dialog.dismiss()
